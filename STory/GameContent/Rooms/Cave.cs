...
namespace STory.GameContent.Rooms
{
    ...
    class Cave :Room
    {
        ...
        private void friend()
        {
            ...
            d.AddOption(new GenericOption("Petting the Dog-Ghost", true));
            d.AddOption(new GenericOption("Flee", true));
            ((GenericOption)d.getLatetsOption()).AddExecutionAction(() => flee());
            d.selectOption();*/
        }
        public override bool OnEnter()
        {
            ...
            d.AddOption(new GenericOption("Attack", true));
            d.AddOption(new GenericOption("Hello spooky creature? How can I help you?", true));
            ((GenericOption)d.getLatetsOption()).AddExecutionAction(() => friend());
            d.selectOption();
